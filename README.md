...
## Version
**0.3.0** . Recommended for reference only. Stay tuned
...
## Decription
This small script (25.9 kb) will generate an audio player on your web page. The package includes icons and css. 
